...
RSpec.describe "Member List Friend" do
  ...
  describe "#active" do
    ...
    it "has zero friend's active" do
      expect(@init_list_friend_of_member.active.to_a.count).to eq(0)
    end
    ...
    it "has one friend's active" do
      ...
      expect(@init_list_friend_of_member.active.to_a.count).to eq(1)
    end
  end
  ...
  describe "#block" do
    ...
    it "has zero friend's blck" do
      expect(@init_list_friend_of_member.block.to_a.count).to eq(0)
    end

    it "has one friend's block" do
      create(:friend, follower: member, followed: friend, block: true, active: true, status: 1)
      expect(@init_list_friend_of_member.block.to_a.count).to eq(1)
    end
  ...
  describe "#your_request" do
    ...
    it "has zero friend's your request" do
      expect(@init_list_friend_of_member.your_request.to_a.count).to eq(0)
    end

    it "has one friend's your request" do
      create(:friend, follower: member, followed: friend, status: 0)
      expect(@init_list_friend_of_member.your_request.to_a.count).to eq(1)
    end
  ...
  describe "#friend_request" do
    ...
    it "has zero friend's request" do
      expect(@init_list_friend_of_member.friend_request.to_a.count).to eq(0)
    end

    it "has one friend's request" do
      create(:friend, follower: member, followed: friend, status: 2)
      expect(@init_list_friend_of_member.friend_request.to_a.count).to eq(1)
    end
  end

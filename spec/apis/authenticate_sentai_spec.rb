...
describe "POST /authen/sentai", type: :api do
  ...
  it "authen with device_token" do
    post '/authen/signin_sentai.json', FactoryGirl.attributes_for(:sentai).merge(password: "Nutty509", device_token: "12345678 c0c342f0 3f2b6526 46fcf7b9 386c307d 2ac40035 25c1a045 74eda000"), format: :json

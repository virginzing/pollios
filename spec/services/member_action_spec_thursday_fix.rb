...
#   #   it "- Member[1]'s friend list does not contain member[2]." do
#   #     # expect(Member::MemberList.new(@member_1).not_exist_incoming_request?(@member_2)).to be true
#   #   end

#   #   it "- Member[2]'s friend list does not contain member[1]." do
#   #     # expect(Member::MemberList.new(@member_2).not_exist_outgoing_request?(@member_1)).to be true
#   #   end
#   # end
# end

# #   context '#unfriend: Member[1] sends #unfriend fails to request Member[2]' do
# #     before(:context) do
# #       @member_1 = create(:member)
# #       @member_2 = create(:member)
# #     end

# #      it '- Member[1] can not unfriend your self' do
...
# #     end
# #     it '- Member[1] are not friend member[2]' do
...
# #   context '#follow: Member[1] sends follow request to celebrity_member' do
# #     before(:context) do
# #       @member_1 = create(:member)
...
# #     it '- Member[1] appears in follower list of celebrity_member' do
# #       expect(Member::MemberList.new(@celebrity_member).followers).to include(@member_1)
# #     end
# #   end

# #   context '#follow: Member[1] fails to send follow request to celebrity_member' do
# #     before(:context) do
# #       @member_1 = create(:member)
# #       @member_2 = create(:member)
# #       @celebrity_member = create(:celebrity_member)
...
# #     it '- Member[1] are already followed celebrity_member' do
# #       @follow = Member::MemberAction.new(@member_1, @celebrity_member).follow
...
# #     it '- Member[1] blocked celebrity_member' do
...
# #     it '- Member[1] is blocked by celebrity_member' do
...
# #   context '#unfollow: Member[1] sends unfollow request to celebrity_member' do
# #     before(:context) do
# #       @member_1 = create(:member)
# #       @celebrity_member = create(:celebrity_member)
...
# #      it '- Member[1] disappears from follower list of celebrity_member' do
# #       expect(Member::MemberList.new(@celebrity_member).followers).not_to include(@member_1)
# #     end
# #   end

# #   context '#unfollow: Member[1] fails to send unfollow request to celebrity_member' do
# #     before(:context) do
# #       @member_1 = create(:member)
# #       @celebrity_member = create(:celebrity_member)
# #     end
# #     it '- Member[1] can not send unfollow themself' do
...
# #     it '- Member[1] are not following member[2]' do
...
# #     it '- Member[2] disappears from outgoing friend request list of member[1]' do
# #       expect(Member::MemberList.new(@member_1).not_exist_outgoing_request?(@member_2)).to be true
# #     end

# #     it '- Member[1] disappears from incoming friend request list of member[2]' do
# #       expect(Member::MemberList.new(@member_2).not_exist_incoming_request?(@member_1)).to be true
# #     end
# #   end

# #   context '#deny: Member[2] fails to #deny friend request from member[1]' do
# #     before(:context) do
# #       @member_1 = create(:member)
# #       @member_2 = create(:member)
# #       @celebrity_member = create(:celebrity_member)
# #     end
# #     it '- Member[1] does not send add friend request' do
...
# #   context '#cancel: Member[2] cancels friend request from member[1]' do
# #     before(:context) do
# #       @member_1 = create(:member)
# #       @member_2 = create(:member)
...
# #   context '#cancel: Member[2] fails to cancel friend request from member[1]' do
# #     before(:context) do
# #       @member_1 = create(:member)
# #       @member_2 = create(:member)
# #     end

# #     it '- Member[1] dose not send add friend request' do
...
# #   context '#block: Member[1] #blocks member[2]' do
# #     before(:context) do
# #       @member_1 = create(:member)
# #       @member_2 = create(:member)
...
# #     it '- Member[2] appears in block list of member[1]' do
# #       expect(Member::MemberList.new(@member_1).already_block_with?(@member_2)).to be true
# #     end
# #   end

# #   context '#block: Member[1] fails to #block member[2]' do
# #     before(:context) do
# #       @member_1 = create(:member)
# #       @member_2 = create(:member)
# #     end
...
# #   context '#unblock: Member[1] unblock to request Member[2]' do
# #     before(:context) do
# #       @member_1 = create(:member)
# #       @member_2 = create(:member)
...
# #     it '- Member[2] appears in unblock list of member[1]' do
# #       expect(Member::MemberList.new(@member_2).not_exist_incoming_request?(@member_1)).to be true
# #     end
# #   end

# #   context '#unblock: Member[1] unblock fails to request' do
# #     before(:context) do
# #       @member_1 = create(:member)
# #       @member_2 = create(:member)
# #     end

# #     it '- Member[1] can not unblock your self' do
# #       expect { Member::MemberAction.new(@member_1, @member_1).unblock } \
# #         .to raise_error(ExceptionHandler::UnprocessableEntity, GuardMessage::Member.unblock_self)
# #     end
...
# #   context '#report: Member[1] #report(and_block) to fails request Member[2]' do
# #     before(:context) do
# #       @member_1 = create(:member)
# #       @member_2 = create(:member)
# #     end

# #     it '- Member[1] can not report your self' do
# #       expect { Member::MemberAction.new(@member_1, @member_1).report(true) } \
# #         .to raise_error(ExceptionHandler::UnprocessableEntity, GuardMessage::Member.report_self)
# #     end
# #   end

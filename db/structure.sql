...
--
-- Name: index_members_on_province_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_members_on_province_id ON members USING btree (province_id);

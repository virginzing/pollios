RailsAdmin.config do |config|
  ...
  config.included_models = ['Trigger', 'CollectionPollSeries', 'CollectionPollSeriesBranch', 'ApiToken', 'BranchPollSeries', 'FeedbackRecurring', 'Bookmark', 'AccessWeb', 'Branch', 'BranchPoll', 'CompanyMember', 'SavePollLater', 'UnSeePoll', 'HistoryPurchase', 'Admin', 'Poll', 'PollSeries', 'Choice', 'Member', 'Provider', 'Friend', 'Campaign', 'Tag', 'Tagging', 'Guest', 'Group', 'Recurring', 'SharePoll', 'PollGroup', 'PollMember', 'HiddenPoll',
    ...
    'SharePoll', 'NotifyLog', 'InviteCode', 'MemberInviteCode', 'MemberReportPoll', 'MemberReportMember', 'Activity', 'Comment','Suggest', 'Company', 'UserStats', 'PollStats', 'GroupStats', 'Role','GroupSurveyor', 'RequestGroup', 'GroupCompany', 'CoverPreset']

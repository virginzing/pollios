RailsAdmin.config do |config|
  ...
  config.included_models = ['AccessWeb', 'Branch', 'BranchPoll', 'CompanyMember', 'SavePollLater', 'UnSeePoll', 'HistoryPurchase', 'Admin', 'Poll', 'PollSeries', 'Choice', 'Member', 'Provider', 'Friend', 'Campaign', 'Tag', 'Tagging', 'Guest', 'Group', 'Recurring', 'SharePoll', 'PollGroup', 'PollMember', 'HiddenPoll',

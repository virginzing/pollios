class NotReceiveRandomRewardPollWorker
  ...
  def perform(sender_id, poll_id, list_member, message = nil)
    ...
    list_hash_reward_with_member_ids ||= @apn_not_receive_random_reward_poll.list_hash_reward_with_member_ids
    ...
    device_ids.each_with_index do |device_id, index|
      ...
      @notf.alert = @apn_not_receive_random_reward_poll.custom_message
      @notf.sound = true
    ...
    "NotReceiveRandomRewardPollWorker => #{e.message}"
  end
end
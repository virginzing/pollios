...
# curl -H "Content-Type: application/json" -d '{"member_id": 3, "friend_id": 106}' -X POST http://localhost:3000/friend/add_friend.json -i
...
# curl -H "Content-Type: application/json" -d '{"member_id": 106, "friend_id": 3}' -X POST http://localhost:3000/friend/accept.json -i
...
# curl -H "Content-Type: application/json" -d '{
#     "member_id": "106", 
#     "title": "คุณชอบเลี้ยงสุนัขกี่ตัว",
#     "expire_date": "2",
#     "choices": "1 ตัว, 2 ตัว, 3 ตัว"

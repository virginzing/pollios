class ApplicationController < ActionController::Base
  ...
  def history_voted_viewed
    @history_voted  = @current_member.history_votes.includes(:choice).collect!  { |voted| [voted.poll_id, voted.choice_id, voted.choice.answer, voted.poll_series_id, voted.vote] }

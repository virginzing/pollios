class AuthenSentaiController < ApplicationController
  ...
  private
    ...
    def resetpassword_params
	  ...
	  def signup_params
	    params.permit(:select_service, :approve_brand, :email, :password, :username, :first_name, :last_name, :avatar, :fullname, :device_token, :birthday, :gender, :member_type, :key_color, :address, :company_id)
	  end

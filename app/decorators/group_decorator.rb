class GroupDecorator < ApplicationDecorator
  ...
  def show_cover_group_in_company
    if object.cover_preset == "0"
      image_tag( object.cover.url(:cover), data: { toggle: "tooltip", placement: "top", :'original-title' => object.name }, alt: "user", class: 'img img-responsive center-block', size: "320x130" )    
    else

class Member::SettingUpdate
  ...
  attr_reader :member, :params_profile, :params_public_id, :params_personal, :params_facebook, :params_notifications
  ...
  def facebook(params)
    @params_facebook = params
    process_update_facebook_connection
  end

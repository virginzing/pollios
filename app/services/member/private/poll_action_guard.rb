module Member::Private::PollActionGuard
  ...
  def can_create?
    ...
    return [false, "You don't have any public poll quota."] if poll_params[:public] && public_quota_limit_exceed?
  ...
  def can_promote?
    ...
    return [false, "You don't have any public poll quota."] if public_quota_limit_exceed?

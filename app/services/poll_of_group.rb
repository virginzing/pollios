class PollOfGroup
  ...
  def poll_of_group
    ...
    @query = Poll.unscoped.order("updated_at DESC, created_at DESC").available.joins(:poll_groups).select("polls.*, poll_groups.share_poll_of_id as share_poll, poll_groups.group_id as group_of_id")
